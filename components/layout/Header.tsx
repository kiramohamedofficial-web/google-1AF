                    ...
                    <div className="flex-1 flex items-center justify-end gap-2">
                        ...
                        <div ref={notificationRef} className="relative">
                            <button 
                                ...
                                className="p-3 rounded-full bg-transparent text-[hsl(var(--color-text-secondary))] hover:bg-black/5 dark:hover:bg-white/10 transition-colors relative"
                                aria-label="Open notifications"
                            >
                                <IconDisplay value={iconSettings['header_notifications']} fallback={<BellIcon />} />
                                {unreadCount > 0 && (
